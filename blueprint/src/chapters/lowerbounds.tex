...
\end{theorem}
\begin{proof}
  \uses{thm:lowerbounds-shannon-upper}
  Refine the column library by grouping the rows of the truth table into
  strips and sharing the computation of each strip's column patterns.
\end{proof}
