...
| [Circuit migration](CircuitMigration.md) | Moving every circuit development to CSLib's circuit model: redefined measures and families, the converse translation, and consumer ports | Phase 1 and steps 2.1–2.2 done on `circuit-migration`; the rest planned |
